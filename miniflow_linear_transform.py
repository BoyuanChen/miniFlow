...
class Linear(Node):
    ...
    def forward(self):
        ...
        Your code goes here!
        """
        input_data = self.inbound_nodes[0].value
        weight_data = self.inbound_nodes[1].value
        bias_data = self.inbound_nodes[2].value
        self.value = np.dot(input_data, weight_data) + bias_data
